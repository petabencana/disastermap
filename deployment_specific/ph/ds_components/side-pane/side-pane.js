...
export class SidePane {
  ...
  constructor(Locales, Config) {
    ...
    this.last_report_received_on = [
      { en: 'Reports remain active for 2 hours', tl: 'Ang mga report ay aktibo sa loob ng 2 oras'},
      { en: 'Reports remain active for 12 hours', tl: 'Masa aktif laporan: 12 jam'},
      { en: 'Reports remain active for 12 hours', id: 'Masa aktif laporan: 12 jam'},
      { en: 'Reports remain active for 2 hours', tl: 'Masa aktif laporan: 2 jam'},
      { en: 'Reports remain active for 6 hours', tl: 'Masa aktif laporan: 6 jam'},
      { en: 'Reports remain active for 6 hours', tl: 'Masa aktif laporan: 6 jam'},
      { en: 'Reports remain active for 12 hours', tl: 'Masa aktif laporan: 12 jam'}
    ]
    ...
    this.all_legends_data = [
      ...
      {
        legend_name: 'floods',
        legend_title: { en: 'floods', tl: 'baha' },
        legend_title_icon: 'deployment_specific/pb/ds_assets/icons/Add_Report_Icon_Flood.png',
        col_1_title: { en: 'Flood Gauges', tl: 'Tinggi Muka Air' },
        col_2_title: { en: 'Flood Depth (cm)', tl: 'Lalim ng Baha (cm)' },
        legend_data: [
          {
            col_1: {
              text: { en: 'Alert Level 1', tl: 'Siaga 1' },
          ...
          {
            col_1: {
              text: { en: 'Alert Level 2', tl: 'Siaga 2' },
              icon: 'assets/icons/floodgauge_2.svg',
              color: '#FF8300' //orange
            },
            col_2: {
              text: { en: '71 - 150', tl: '71 - 150' },
              color: '#FF8300' //orange
            }
          },
          {
            col_1: {
              text: { en: 'Alert Level 3', tl: 'Siaga 3' },
              icon: 'assets/icons/floodgauge_3.svg',
              color: '#FFFF00' //yellow
            },
            col_2: {
              text: { en: '10 - 70', tl: '10 - 70' },
              color: '#FFFF00' //yellow
            }
          },
          {
            col_1: {
              text: { en: 'Alert Level 4', tl: 'Siaga 4' },
              icon: 'assets/icons/floodgauge_4.svg',
              color: '#9ce233' //green
            },
            col_2: {
              text: { en: 'Use Caution', tl: 'Maging maingat' },
              color: '#A0A9F7' //purple
            }
          }]
      },
